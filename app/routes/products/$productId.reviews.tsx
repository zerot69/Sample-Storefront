          ...
          <article>
            <div className="mb-4 flex items-center space-x-6">
              <img
                ...
                alt={product.reviews[0].name}
              />
              <div className="flex-grow space-y-1 font-medium dark:text-white">
                <p>
            ...
            <h3 className="my-4 text-sm font-semibold text-gray-900 dark:text-white">
              {product.reviews[0].reviewTitle}
            </h3>
